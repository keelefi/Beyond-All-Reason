...
test("Transport Ferry Add Ten Transports To Three Ferry Routes", function ()
    ...
    assert.is.equal(1, #ferryRoute1.serversReady, "Ferry route 1 has one transport ready to serve passengers")
    assert.is.equal(1, #ferryRoute2.serversReady, "Ferry route 2 has one transport ready to serve passengers")
    assert.is.equal(1, #ferryRoute3.serversReady, "Ferry route 3 has one transport ready to serve passengers")
    ...
    assert.is.equal(2, #ferryRoute1.serversReady, "Ferry route 1 has two transports ready to serve passengers")
    assert.is.equal(2, #ferryRoute2.serversReady, "Ferry route 2 has two transports ready to serve passengers")
    assert.is.equal(2, #ferryRoute3.serversReady, "Ferry route 3 has two transports ready to serve passengers")
    ...
    assert.is.equal(2, #ferryRoute1.serversReady, "Ferry route 1 has two transports ready to serve passengers")
    assert.is.equal(5, #ferryRoute2.serversReady, "Ferry route 2 has five transports ready to serve passengers")
    assert.is.equal(2, #ferryRoute3.serversReady, "Ferry route 3 has two transports ready to serve passengers")
    ...
    assert.is.equal(2, #ferryRoute1.serversReady, "Ferry route 1 has two transports ready to serve passengers")
    assert.is.equal(5, #ferryRoute2.serversReady, "Ferry route 2 has five transports ready to serve passengers")
    assert.is.equal(6, #ferryRoute3.serversReady, "Ferry route 3 has six transports ready to serve passengers")
end)
...
test("Transport Ferry Add And Remove Transports Between Three Ferry Routes", function ()
    ...
    assert.is.equal(5, #ferryRoute1.serversReady, "Ferry route 1 has five transports ready to serve passengers")
    assert.is.equal(4, #ferryRoute2.serversReady, "Ferry route 2 has four transports ready to serve passengers")
    assert.is.equal(4, #ferryRoute3.serversReady, "Ferry route 3 has four transports ready to serve passengers")
    ...
    assert.is.equal(3, #ferryRoute1.serversReady, "Ferry route 1 has three transports ready to serve passengers")
    assert.is.equal(1, #ferryRoute2.serversReady, "Ferry route 2 has one transport ready to serve passengers")
    assert.is.equal(9, #ferryRoute3.serversReady, "Ferry route 3 has nine transports ready to serve passengers")
    ...
    assert.is.equal(3, #ferryRoute1.serversReady, "Ferry route 1 has three transports ready to serve passengers")
    assert.is.equal(9, #ferryRoute2.serversReady, "Ferry route 2 has nine transports ready to serve passengers")
    assert.is.equal(1, #ferryRoute3.serversReady, "Ferry route 3 has one transport ready to serve passengers")
end)
