...
function addTest(testName, testFunction)
	...
	log(LOG.DEBUG, "[addTest] added test " .. tostring(testName))
	log(LOG.DEBUG, "[addTest] test amount is: " .. tostring(#globalTests))
end
...
local function loadTestFromFile(filename)
	...
	setfenv(addTest, testEnvironment)
